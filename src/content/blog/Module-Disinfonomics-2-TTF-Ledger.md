---
title: "Module: TTF Simplest Form - Write the Ledger"
slug: "Module-Disinfonomics-2-TTF-Ledger"
author: "SAUFEX Consortium"
date: "2026-01-25"
description: "Turn slogans into trades. If you can't write the ledger, you can't change the ledger."
...
Mark 2 rows as "spillover" (externalized costs).
Add 1 "internalisation" row (who could absorb currently externalized cost).
...
2. Design interventions that change incentives
3. Predict how actors will adapt
4. Measure success by transaction disruption, not belief change
...
1. Build a 6-row TTF covering key actors
2. Identify the row where value extraction is highest
3. Identify the row where spillover cost is highest
4. Propose one internalisation mechanism
5. Write the bottom line
6. Assessment + Confidence + Next action for intervention
