---
title: "Module: Basic FIMI Concepts"
slug: "Module-Basic-FIMI-Concepts"
author: "SAUFEX Consortium"
date: "2026-01-23"
description: "Introduction to Foreign Information Manipulation and Interference - understanding what it is, how to recognize it, and what to do about it."
...
1. **Is there harm?** (What's the negative effect?)
2. **Is there coordination?** (Patterns suggesting organized activity)
3. **Is there deception?** (About identity, origin, or intent)
4. **What's the scale?** (Industrial reach vs. organic spread)
...
**What you produce:**
1. Assessment of what's happening
...
If amplification is the problem → Gen 4 responses (reduce reach)
If content is the problem → Gen 2/3 responses (debunk/prebunk)
If both → layered approach
...
**Mistake 1: "Cui bono" as evidence**
"This benefits Russia, therefore Russia did it."
Reality: Many actors may benefit. Benefit isn't causation.

**Mistake 2: Assuming coordination from alignment**
"These accounts share the same message, therefore coordinated."
Reality: Organic movements also share messages. Look for behavioral coordination, not just content alignment.

**Mistake 3: Foreign = illegitimate**
Not all foreign speech is manipulation. Foreign journalists, activists, and citizens have legitimate voices too.

**Mistake 4: Attribution before investigation**
"It's Russian disinformation" as starting hypothesis rather than conclusion.
...
1. **What do I see?** (Observable behavior)
2. **What signals am I relying on?** (Strong/medium/weak)
3. **What don't I know?** (Gaps in evidence)
4. **What would change my assessment?** (What evidence would strengthen/weaken)
5. **What's proportionate action?** (Given evidence tier)
...
1. List the signals you see (classify as strong/medium/weak)
2. What additional information would you seek?
3. Write a 3-sentence assessment with confidence level
4. Recommend next action
5. Identify one thing you explicitly will NOT claim
