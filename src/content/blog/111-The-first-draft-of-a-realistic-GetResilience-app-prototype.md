...
---
## Introduction
While the preliminary outline of the [GetResilience app]( https://getresilience.eu/) provocatively proposes a simplification of the current challenging flagging process under the DSA, a realistic prototype needs to adhere to both the DSA and the Saufex objectives and results and solve ten major dilemmas (see: [blog post 110](…).\
...
| L4 | System-assisted RC notice | DSA-compliant notice (enhanced) | 
RC (primary), system (tooling only) |
**Key principles**
