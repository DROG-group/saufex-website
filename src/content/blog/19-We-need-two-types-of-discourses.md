---
title: "(19) We need two types of discourses"
slug: "19-We-need-two-types-of-discourses"
...
Nevertheless, quite a proposed interventions to deal with mis- and disinformation rely on the primacy of accuracy: for instance fact-checking (level one of [beliefs](https://saufex.eu/post/12-Summary): information incidents), debunking (level two of beliefs: information campaigns), media literacy (level three of beliefs: rationality). Stephan Lewandowsky calls discourses based on the primacy of accuracy ‘fact-speaking’.
...
As was described in [the draft module on how beliefs form](https://saufex.eu/post/9-How-beliefs-form), our beliefs are the result of causal patterns we start seeing around us. Based on our experiences, we start to formulate and test causal predictions. But, as we saw in [the draft module on sustaining beliefs](https://saufex.eu/post/10-Module-Sustaining-beliefs), we also start to identify with our predicted outcomes. We start to favor any information that shows us our predictions were correct, and see anything that shows us our predictions were wrong as threatening. Instead of observing what ‘is’, we start to see around us what ‘ought’ to happen – our confirmation bias.

In a situation of affective polarisation, that what ‘ought’ to happen becomes groupish and ruthless. We start to see any other outcome than what ought to happen as a threat against both our individual and our group identity. And we are willing to defend ourselves with any means possible. This is why accuracy matters less to us than signalling to our in-group that we stand with them.
