...
The EEAS definition thus leans towards interpreting FIMI as a hybrid threat; see for instance the [European Commission](https://defence-industry-space.ec.europa.eu/eu-defence-industry/hybrid-threats_en) on hybrid threats: “Hybrid threats refer to when, state or non-state, actors seek to exploit the vulnerabilities of the EU to their own advantage by using in a coordinated way a mixture of measures (i.e. diplomatic, military, economic, technological) while remaining below the threshold of formal warfare. Examples are the hindering of democratic decision-making processes by massive disinformation campaigns, using social media to control the political narrative or to radicalise, recruit and direct proxy actors.”
...
The current default practice to link FIMI incidents and campaigns to foreign actors is by painstakingly collecting detailed information: \[_edited_\] _mostly keeping track of the infrastructure used and observables that link to a foreign outlet_. This research might take months, even years, and often only results in identifying a culprit with a high probability rather than absolute certainty. Note that the research focuses mostly on behavior rather than on narratives.
