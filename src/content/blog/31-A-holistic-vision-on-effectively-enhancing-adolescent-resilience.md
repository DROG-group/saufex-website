---
title: "(31) A holistic vision on effectively enhancing adolescent resilience"
slug: "31-A-holistic-vision-on-effectively-enhancing-adolescent-resilience"
...
## [](#Scientific-corroboration)Scientific corroboration
...
## [](#Dislocation-and-its-threat-over-time)Dislocation and its threat over time
...
## [](#Aggravating-factors-and-classroom-dynamics)Aggravating factors and classroom dynamics
...
## [](#Current-response-guidelines-for-teachers)Current response: guidelines for teachers
...
The default response to this situation has been to interpret it as a teacher problem and come up with support for teachers in the form of guidelines. Examples of such guidelines include those from the Council of Europe on teaching controversial issues through education for democratic citizenship and human rights ([pdf](https://rm.coe.int/22122020-teaching-controversial-issues-final-web/1680a12735)), [Google's guidelines for classroom discussions of controversial topics](https://sites.google.com/a/newschool.edu/faculty-professional-development-network/home-page/equity-diversity-and-inclusion/engaging-difficult-dialogues/guidelines-for-classroom-discussions-of-controversial-topics), [Edutopia’s advice on productive classroom debates on sensitive topics](https://www.edutopia.org/article/productive-classroom-debates-sensitive-topics/), [Oxfam's guide for teachers on controversial issues](https://policy-practice.oxfam.org/resources/teaching-controversial-issues-a-guide-for-teachers-620473/), [UNESCO's materials on countering Holocaust denial and distortion through education](https://unesdoc.unesco.org/ark:/48223/pf0000392455), and the [European Commission’s guidelines for educators on tackling disinformation and promoting digital literacy](https://op.europa.eu/en/publication-detail/-/publication/a224c235-4843-11ed-92ed-01aa75ed71a1/language-en), of which I am co-author. And, there are books, quite a few books, that offer their advice.

## [](#Threats-to-democratic-freedoms)Threats to democratic freedoms
...
## [](#Need-for-a-new-approach)Need for a new approach
...
## [](#Our-format-and-method-Interdemocracy)Our format and method: Interdemocracy

To address aggravated adolescent partial dislocation, we propose a format and method called [Interdemocracy](https://interdemocracy.wordpress.com/). This approach creates a space between people—a temporary suspension of group loyalties and judgment—in which individuals can both express and absorb otherness based on their own experiences.
...
## [](#Introducing-the-Youth-Resilience-Council)Introducing: the Youth Resilience Council
...
## [](#A-national-set-up)A national set-up
